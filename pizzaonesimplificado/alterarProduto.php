...
if (isset($_POST['submit_update'])) {
    ...
    $nova_imagem = $_POST['imagem'] ?? null; 


    $sql_update = "UPDATE produtos SET preco = ?, tipo = ?, imagem = ?, ativo = ? WHERE id = ?";
        
    try {
        $stmt_update = $pdo->prepare($sql_update);
        $stmt_update->execute([$novo_preco, $novo_tipo, $nova_imagem, $novo_ativo, $id_produto]);
...
$sql_produtos = "SELECT id, nome, preco, tipo, imagem, ativo FROM produtos ORDER BY tipo, nome ASC";
